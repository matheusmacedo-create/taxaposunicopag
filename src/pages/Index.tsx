      ...
      <Card className="w-full max-w-3xl shadow-lg rounded-lg">
          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="flex space-x-2">
              ...
              <Button 
                ...
                disabled={loadingCnpj || (!useMockCnpj && (!cnpjInput || cnpjInput.replace(/\D/g, "").length !== 14))}
                className="px-6"
              >
                {loadingCnpj ? (
                  <>
                    <LoadingIcon className="mr-2" /> Buscando...
                  </>
                ) : (
                  "Buscar CNPJ"
                )}
          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                <Button onClick={handleRateSheetUpload} className="w-full" disabled={loadingRates || !rateSheetFile}>
                  {loadingRates ? (
                    <>
                      <LoadingIcon className="mr-2" /> Analisando...
                    </>
                  ) : (
              ...
              <div className="space-y-4">
                <Label className="text-lg font-medium">Insira Manualmente</Label>
        ...
        {step === 3 && (
          <CardContent className="space-y-4 p-6">
            ...
            <Button onClick={handleGenerateProposals} disabled={loadingProposals || !cnpjData || !currentRates.debito}>
              {loadingProposals ? (
                <>
                  <LoadingIcon className="mr-2" /> Gerando...
                </>
              ) : (
                "Gerar Propostas"
              )}
          ...
          <CardContent className="space-y-4 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <Label className="text-base font-medium">Contrato Social</Label>
                <FileUpload
              ...
              <div className="space-y-3">
                <Label className="text-base font-medium">RG/CNH do Proprietário</Label>
                <FileUpload
              ...
              <div className="space-y-3">
                <Label className="text-base font-medium">Selfie do Proprietário</Label>
                <FileUpload
              ...
              <div className="space-y-2">
                ...
                >
                  {loadingDocuments ? (
                    <>
                      <LoadingIcon className="mr-2" /> Processando Documentos...
                    </>
                  ) : (
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  {documentUploadStatus.cnpjCard === "success" && (
                    <a href={cnpjCardUrl || "#"} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline flex items-center">
                      <Icon name="cnpj" className="h-4 w-4 mr-1" /> Cartão CNPJ Gerado
                    </a>
                  )}
        ...
        {step > 1 && (
          <CardFooter className="flex justify-between p-6 bg-unicopag-light-gray rounded-b-lg">
            ...
            {step === 5 && (
              <Button onClick={handleFinalizeProposal} disabled={isNextButtonDisabled}>
                Finalizar Proposta
              </Button>
            )}
          </CardFooter>
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-4 py-4">
            <div className="flex items-center space-x-2">
              <Icon name="email" className="h-5 w-5 text-unicopag-blue" />
              <Button
                variant="outline"
                className="flex-1"
                onClick={() => {
            ...
            <div className="flex items-center space-x-2">
              <Icon name="whatsapp" className="h-5 w-5 text-unicopag-blue" />
              <Button
                variant="outline"
                className="flex-1"
                onClick={() => {
