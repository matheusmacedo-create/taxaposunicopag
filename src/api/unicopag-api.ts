...
export interface ProposalDetail extends RecentProposal {
  cnpjData: CnpjData;
...
export const fetchProposalDetail = async (proposalId: string): Promise<ProposalDetail | null> => {
  toast.loading("Carregando detalhes da proposta...", { id: "proposal-detail" });
  try {
    await new Promise((resolve) => setTimeout(resolve, 1000));
    ...
    const mockProposalDetail: ProposalDetail = {
      ...
      proposalType: "Equilibrada",
      date: "2024-10-26",
      cnpjData: {
        cnpj: "12.345.678/0001-00",
        razao_social: "Padaria do João Ltda",
        cnae_fiscal: "4711-3/01",
        cnae_fiscal_descricao: "Comércio varejista de mercadorias em geral, com predominância de produtos alimentícios - hipermercados",
        endereco: "Rua das Flores, 123 - Centro, São Paulo - SP",
        situacao_cadastral: "ATIVA",
        mcc: "5411",
        email_proprietario: "joao@padariadojoao.com.br",
        telefone_proprietario: "11987654321",
      },
      currentRates: {
        debito: 1.80,
        creditoVista: 2.50,
        creditoParcelado: 4.20,
      },
      selectedProposal: {
        type: "Equilibrada",
        description: "Taxa intermediária, com vantagem em um ponto específico.",
      ...
      responsibleEmail: "joao@padariadojoao.com.br",
      documents: {
        contractUrl: "https://mock-drive.com/files/12345678000100/contract/contrato.pdf",
        idUrl: "https://mock-drive.com/files/12345678000100/id/rg.pdf",
        selfieUrl: "https://mock-drive.com/files/12345678000100/selfie/selfie.jpg",
        cnpjCardUrl: "https://mock-drive.com/files/12345678000100/cnpj-card/cartao.pdf",
      },
      status: "sent",
      createdAt: "2024-10-26T10:30:00Z",
      updatedAt: "2024-10-26T14:45:00Z",
    };

    toast.success("Detalhes da proposta carregados!", { id: "proposal-detail" });
    return mockProposalDetail;
  } catch (error) {
    console.error("Error fetching proposal detail:", error);
    toast.error("Erro ao carregar detalhes da proposta.", { id: "proposal-detail" });
    return null;
  }
};
